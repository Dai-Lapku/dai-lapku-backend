...
import ua.edu.ukma.dailapku.dailapkubackend.service.UserInfoService;
...
public class SecurityConfig {
    ...
    public SecurityConfig(PasswordEncoder passwordEncoder, UserInfoService userInfoService) {
